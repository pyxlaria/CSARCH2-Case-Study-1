...
Open the Google Colab notebook using the link above. Once the notebook is open, run the first code box and scroll down to step 2 (for GUI), run the setup cell by simply clicking the run button (usually located at the top left). Ensure that both are running.
...
Link: https://youtu.be/fI_BwuEW-bE
